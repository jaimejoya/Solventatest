                        ...
                        <table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    <p>Hemos enviado este correo,  porque acaban de ser modificada una novedad de la sede <b>{{$email['sucursal']['name']}}</b> la novedad es la siguiente.</p> 
                                        ...
                                        <p>
                                            <table class="table" style="width: 100%;font-size:11px" align="center">                                                    
                                                <tr>
                                                    ...
                                                    <th align="center" style="border: 1px solid #DF7401;text-align:center">Usuario que modifico la Novedad</th>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td align="center" style="border-right: 1px solid #DF7401;border-bottom: 1px solid #DF7401;text-transform:uppercase">{{$email['data']['user_register']}}</td>                                                                                                                                                                  
                                                    <td align="center" style="border-bottom: 1px solid #DF7401;text-transform:uppercase">{{$email['user_modificate']}}</td>                                                            
