                            ...
                            <table style="{{ $style['body_action'] }}" align="left" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="left">Hola. <b></b><br/><br/>
                                        ...
                                        <p>Se realiza envio del soporte de factura del cliente {{$email['company']['name']}} de la sede {{ $email['sucursal']['name']}}.</p>

                                        <p>Por favor inicie sesión en la plataforma web de IPM-X e ingrese al <b>Módulo Extintores Portátiles</b> e ingrese al submodulo <b>Formatos de Servicio</b> para visualizar y validar las actividades de mantenimiento realizadas a los equipos.</p>
