...
<html>
    ...
    <style>
        ...
        .button {
            ...
            background-color: #3869D4; /* Color de fondo */
    ...
    <body style="{{ $style['body'] }}" >
        ...
        <div style="text-align:justify;margin: 0px 100px ">
                        ...
                        <table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    <p>Este correo se envía para notificarle que la propuesta económica que se ha revisado ha sido rechazada debido a la necesidad de realizar ciertos cambios.</p>

                                    <p>Para conocer los detalles de los ajustes que se requieren, por favor siga los siguientes pasos y consulte los comentarios asociados a la propuesta económica en la plataforma:</p>

                                    <ol>
                                        <li>Acceda al <strong>Módulo Costos y Presupuesto</strong>.</li>
                                        <li>Dirígase al <strong>Submódulo de Tabla Costos y Presupuestos</strong>.</li>
                                        ...
                                        <li>Dirijase al apartado <strong>Comentarios</strong> y realice los ajustes que se requieren en la propuesta económica.</li>
                                    </ol>
            ...
            <div>
                <p>Para revisar la propuesta, haga clic en el siguiente botón:</p>
            ...
            Una vez realizados los cambios solicitados, podrás enviar nuevamente la propuesta para su evaluación.
