    ...
    <body style="{{ $style['body'] }}" >
        ...
        <div style="text-align:justify;margin: 0px 100px ">
                        ...
                        <table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    <p>Hemos enviado este correo, porque necesitamos que revise la siguiente propuesta económica.</p>

                                    <p>Para aprobar la revisión, siga los siguientes pasos:</p>

                                    <ol>
                                        <li>Acceda al <strong>Módulo Costos y Presupuesto</strong>.</li>
                                        <li>Dirígese al <strong>Submódulo de Tabla Costos y Presupuestos</strong>.</li>
                                        <li>Seleccione el tipo de mantenimiento al que desea ver la propuesta económica.</li>
                                        <li>Elija la opción <strong>Consultar Propuestas Económicas</strong>.</li>
                                        <li>Seleccione el cliente, el sistema y el subsistema que deseas consultar.</li>
                                        <li>Seleccione la opción <strong>Propuestas Económicas Pendiente por Revisión</strong>.</li>
                                        <li>Verifique si la propuesta económica cumple con lo solicitado. Si cumple con los requisitos solicitados, apruebela; si no, rechacela.</li>
                                    </ol>
            ...
            <div>
                ...
                <p>                                        
                    La Propuesta Económica se adjunta en el correo.  
