                        ...
                        <table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    Hola &nbsp;&nbsp;<b><i>{{ $emailAts['user']['name_user'] }}</i></b>,<br/><br/>

                                    <p>Hemos enviado este correo, con el fin de informar las actividades que han sido asignadas para el dia {{$emailAts['date']}} con el fin de hacer seguimiento al diligenciamiento de el formulario de ATS</p> 
                                    ...
                                    <div>
                                        ...
                                        <p>                                        
                                            ...
                                            Las actividades asignadas son:

                                            <ol>                                                    

                                                @foreach ($emailAts['atsGroup'] as $ats)
                                                    <li>{{$ats['nameSucursal']}}</li>                                                    
                                                    <ol>
                                                        <label for="" style="margin-lef:-12px">Los usuarios asignados para realizar esta labor son:</label> 
                                                        @foreach ($ats['users'] as $user)
                                    ...
                                    Atentamente: 
                                    <b><i>{{ $emailAts['sendEmail']['name_partner'] }}</i></b>

                                    <br>
                                    <br>
                                    <div align="left">
                                        <a href="{{ $emailAts['logo'] }}" target="_blank">
                                            <img  src="{{ $emailAts['logo'] }}" width="180" height="50" alt="CoreUI Logo">
                                        </a>
                                    </div>
