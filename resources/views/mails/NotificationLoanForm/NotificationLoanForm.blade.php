...
<body style="{{ $style['body'] }}">
    <table width="100%" style="text-align:justify;margin: 0px 80px">
        <tr>
            <td style="{{ $style['email-wrapper'] }}" align="left">
                <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                    <tr>
                        <td align="left">Hola <b></b>,<br/><br/>
                            <p>Hemos enviado este correo, porque acaban de realizar el proceso de prestamos y recogida de los extintores portatiles del servicio solicitado</p> <div>
                            <p>De la sede {{ $email['data_sucursal']['client']}}.</p>  

                            <p>Por favor inicie sesion con su cuenta en la plataforma web de IPM-X e ingrese al <b>Módulo Administrativo Extintores</b> e ingrese al submodulo <b>Creación de Servicios</b> para llevar seguimiento del estado del servicio.</p>
        ...
        <tr>
            ...
            <td>
                <table style="{{ $style['email-footer'] }}"  width="570" cellpadding="0" cellspacing="0">    
                    <tr>
                        <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}"><p style="{{ $style['paragraph-sub'] }}"> &copy; {{ date('Y') }} <a style="{{ $style['anchor'] }}" href="{{ url('/') }}" target="_blank">OnlyFire Security S.A.S</a>.
                            Todo los Derechos Reservados. </p>
                        </td>
                    </tr>
                </table>
            </td>
