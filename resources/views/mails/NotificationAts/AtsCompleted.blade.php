                            ...
                            <table style="{{ $style['body_action'] }}" align="left" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="left">Hola.<b></b><br/><br/>
                                        ...
                                        <p>Se a realizado el diligenciamiento del Analisis de Trabajo Seguro (ATS) de la sede {{ $email['name_sucursal']}}.</p>  <div>
                                        

                                        <p>Puede iniciar sesion con su cuenta en la plataforma web de IPM-X e ingrese al <b>Módulo de Seguridad y Salud en el trabajo</b> e ingrese al submodulo <b>Analisis de Trabajo Seguro</b> para visualizar el formato.</p>
