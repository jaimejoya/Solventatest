                            ...
                            <table style="{{ $style['body_action'] }}" align="left" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="left">Hola.<b></b><br/><br/>
                                        ...
                                        <p>Se a realizado el proceso de entrega de los extintores portatiles del servicio solicitado a la sede {{ $email['data_sucursal']['name']}}.</p>  <div>
                                        

                                        <p>Por favor inicie sesion con su cuenta en la plataforma web de IPM-X e ingrese al <b>Módulo Extintores Portatiles</b> e ingrese al submodulo <b>Actividades de Mantenimiento Extintores</b> para visualizar las actividades de mantenimiento realizadas a los equipos.</p>
