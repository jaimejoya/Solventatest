                        ...
                        <table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    <p>Hemos enviado este correo,  porque acaban de ser asignadas las actividades para el dia {{$email['date']}} la realizacion del plan de Inspeccion,Prueba y Mantenimiento.</p> 
                                    ...
                                    <div>
                                        ...
                                        <p>
                                            ...
                                            @foreach ($email['sucursals'] as $sucursal)
                                                ...
                                                <ul>   
                                                    ...
                                                    @foreach ($sucursal['dataActivities'] as $activity)
                                                        <li>{{$activity['activity']}} &nbsp; {{$activity['frequency']}}</li>
                                                    @endforeach
                                                </ul>
                                                ...
                                                <strong>Persona de Contacto:</strong>
                                                    {{$sucursal['person_contact']}}
                                                <br>
                                                
                                                <strong>Número de Contacto:</strong>
                                                    {{$sucursal['mobile_phone']}}
                                                <br>
                                        ...
                                        <p>Por favor inicie sesion con su cuenta en la aplicación Movil IPM-X e ingrese al módulo de Actividades Diarias.</p>
                                        <p>Donde podrá ver la Sede Asignada y Ejecutar las Actividades.</p>

                                        <p>
                                            Es importante Diligenciar el formato ATS y el formato de Covid 19. 
                                        </p>
