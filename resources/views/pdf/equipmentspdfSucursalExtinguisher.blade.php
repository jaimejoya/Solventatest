      ...
      <header>
        <table class="tg" style="max-width: 1200px; width: 100%; background: white;margin-right: 25px; ">
            <tr>
              ...
              <th class="tg-hgcj" rowspan="4"><span style='font-size: 13px;'><br>EQUIPOS EXTINTORES DE LA SEDE {{$curriculum_equipment_system['name_sucursal']}} <br><label for="" style="text-transform: uppercase"><br><br></label> </span></th>
              <th class="tg-amwm" width="20%"><span>{{$curriculum_equipment_system['name_company']}}</span></th>
            </tr>
            <tr>
              <td class="tg-amwm"><span>v.1</span></td>
            </tr>
              <tr>
    ...
    <!-- BODY -->
      ...
      @foreach ($curriculum_equipment_system['subsystems'] as $key => $subsystem)
        ...
        <ul style="margin-top:10px;margin-left:20px;">
          <li><b class="letter" style="font-size:16px"> {{$subsystem["subsystem_id"]}}:&nbsp; {{$key+1}}</b></li>
