...
<html>
  ...
  <body>
    ...
    <!-- HEADER -->
      ...
      <header>
        <table class="tg" style="max-width: 1200px; width: 100%; background: white;margin-right: 25px; ">
            <tr>
              <th class="tg-s6z2" width="20%" rowspan="4"><span>
                <img src="https://ipm-visits.s3.amazonaws.com/{{$curriculum_equipment_system['logo_company']}}" width="100px">
              </span></th>
              <th class="tg-hgcj" rowspan="4"><span style='font-size: 13px;'><br>HOJAS DE VIDA DE LOS EXTINTORES DE LA SEDE {{$curriculum_equipment_system['name_sucursal']}} <br> DEL SISTEMA <br><br><label for="" style="text-transform: uppercase">{{$curriculum_equipment_system['name_system'] }}<br><br></label> </span></th>
              <th class="tg-amwm" width="20%"><span>{{$curriculum_equipment_system['name_company']}}</span></th>
            </tr>
            <tr>
    ...
    <!-- BODY -->
      ...
      @foreach ($curriculum_equipment_system['subsystems'] as $key => $subsystem)

        <ul style="margin-top:10px;margin-left:20px;">
          <li><b class="letter" style="font-size:16px"> Equipos: {{$key+1}}</b></li>
                ...
                <table class="tg" style="margin-top:15px;width:90%;margin-left:-10px;margin-rigth:60px;">
                  ...
                  @foreach ($subsystem['data'] as $key => $equipment )

                    @if ($equipment['dato'] != '')
                      <tr style="text-align: center">
                        <td width="100px">{{$key+1}}</td>
                        <td width="100px">{{$equipment['name']}}</td>
                        <td width="100px">{{$equipment['dato']}}</td>
                      </tr>
