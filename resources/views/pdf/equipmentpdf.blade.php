...
<html>
  ...
  <head>
    <title>{{$curriculum_equipment['name_sucursal']}}</title>
  </head>
  ...
  <body>
        ...
        <table class="tg" style="max-width: 1200px; width: 100%; background: white; margin-left:32px;margin-right: 25px; ">
            <tr>
              <th class="tg-s6z2" colspan="2" rowspan="4"><span>
                <img src="https://ipm-visits.s3.amazonaws.com/{{$curriculum_equipment['logo_company']}}" width="100px">
              </span></th>
              <th class="tg-hgcj" colspan="8" rowspan="4"><span style='font-size: 13px;'><br>EQUIPOS DE LA SEDE <label for="" style="text-transform: uppercase;">{{$curriculum_equipment['name_sucursal']}}</label> <br> DEL SUBSISTEMA<br><br><label for="" style="text-transform: uppercase">{{$curriculum_equipment['name_subsystem'] }}<br><br></label> </span></th>
              <th class="tg-amwm" colspan="2"><span>{{$curriculum_equipment['name_company']}}</span></th>
            </tr>
            <tr>
                <br>
              <td class="tg-amwm" colspan="2"><span>v.3</span></td>
            </tr>
              <tr>
                
                <td class="tg-amwm" colspan="2" ><strong>Cantidad Total de Equipos: {{$curriculum_equipment['total_equipments']}}</strong></td>
                
              </tr>
            <tr>
              <td class="tg-amwm" colspan="2"><span>Fecha: {{date('Y-m-d ')}} </span></td>
            </tr>
    ...
    <!-- BODY -->
        ...
        <ul style="margin-top:10px;margin-left:20px;">
          ...
          <li><b class="letter" style="font-size:16px">{{$curriculum_equipment['name_subsystem']}}</b></li>
            ...
            <table class="tg" style="margin-top:15px;width:90%;margin-left:-10px;margin-rigth:60px;">
                ...
                @foreach ($curriculum_equipment['equipment']['data'] as $key => $data )
                @if ($data['dato'] != '')
