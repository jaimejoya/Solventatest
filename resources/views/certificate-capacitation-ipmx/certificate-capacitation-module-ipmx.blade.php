...
<html lang="es">
<head>
    <title>{{ $template_certificate['name_module'] }}</title>
    <meta charset="UTF-8">
    ...
    <style>
        ...
        .certificate {
            width: 80.5%; /* Ajusta el tamaño según necesites */
            height: 82%;
            display: flex;
...
<body>
    ...
    <div class="certificate">
        ...
        <p class="certificate-text-2">{{ $template_certificate['description_certificate'] }} <strong>{{ ucwords(strtolower($template_certificate['name_module'])) }}</strong> del software</p>
